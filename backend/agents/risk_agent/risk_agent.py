...
class RiskAgent(BaseAgent):
    """
    Risk Agent — deterministic, multi-factor risk scoring.
    ...
    time — entirely in Python. The LLM is used ONLY to explain the result.
    """
    ...
    def _calculate_risk_score(
        ...
        shared/constants.py — no magic numbers.
        """
        score = 0.0
