...
"""
DEPRECATED â€” this module is no longer used.
...
The replacement prompts live in each agent's own module:
    backend/agents/ops_agent/prompt.py       â†’ OPS_AGENT_PROMPT
    backend/agents/risk_agent/prompt.py      â†’ RISK_AGENT_PROMPT
    backend/agents/auditor_agent/prompt.py   â†’ AUDITOR_AGENT_PROMPT
    backend/agents/report_agent/prompt.py    â†’ REPORT_AGENT_PROMPT
"""
import warnings
